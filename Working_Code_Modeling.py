...
from kneed import KneeLocator   #to check how many clusters are present i.e., K= ??
from sklearn.preprocessing import MaxAbsScaler  #scaling ranges fron[-1,1]
from sklearn.metrics import mean_absolute_percentage_error, silhouette_score
from tensorflow.keras.models import Sequential  #to build and train a neural network model in TensorFlow Keras.
from tensorflow.keras.layers import LSTM, Dense  # we can also build model on SARIMA,ARIMA 
from tensorflow.keras.preprocessing.sequence import TimeseriesGenerator #to get the forecasting values or predicting next/future values. 
import pickle #to save the model in local system

# Loading the data
data = pd.read_excel(r"C:/Users/udayk/Desktop/PROJECT 2/MODEL/Medical Inventory Optimaization Dataset.xlsx")
